<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GetStudent.aspx.cs" Inherits="HUST.GetStudent" %>
    ...
    <form id="form1" runat="server">
        <div>
            <ul>
                ...
                <li><a class="active" href="GetStudent.aspx">Show Student</a></li>
